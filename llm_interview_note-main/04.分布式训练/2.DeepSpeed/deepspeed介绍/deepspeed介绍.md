...
![](image_vfi8OaGD7t.png)

**BF16**

**BF16和FP16都是混合精度训练中使用的浮点数表示格式**。

![](image_l1dkF_7Tg7.png)
...
![](image_XNjij0Z1Dh.png)

![](image_B3Zt993aVo.png)
...
![](image_psVU2KOWUS.png)

![](image_tOHRS0iiUq.png)

![](image_JxB5Yju8gj.png)

在DeepSpeed中，一般使用ZeRO-1就足够了。

![](image_hKE_Xt759j.png)
